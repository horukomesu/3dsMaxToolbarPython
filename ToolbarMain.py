...
class MajesticDockWidget(QtWidgets.QDockWidget):
    def __init__(self, parent=None):
        ...
        self.on_enable_filter_toggled(self.enable_filter_cb.isChecked() if self.enable_filter_cb else False)
    ...
    def get_button_states(self):
        states = {}
        states['chkEnableFilter'] = self.enable_filter_cb.isChecked() if self.enable_filter_cb else False
